...
/**
 * The <code>addRemote</code> class provides a Java RMI-compliant interface to the 
 * M-functions from the files:
 * <pre>
 *  D:\\WorkSpace\\MatLab\\ims.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>addRemote</code> instance 
 ...
 * generate RMI server proxy objects for instances of m.add.
 */
public interface addRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>ims</code> M-function with 2 
     * input arguments.  
     *
     ...
     */
    public Object[] ims(int nargout, Object... rhs) throws RemoteException;
